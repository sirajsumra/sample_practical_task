...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.sample.practical.view.splash.SplashActivityViewModel) variable);
        }
        else if (BR.state == variableId) {
            setState((com.sample.practical.view.splash.SplashActivityState) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.sample.practical.view.splash.SplashActivityViewModel ViewModel) {
        this.mViewModel = ViewModel;
    }
    public void setState(@Nullable com.sample.practical.view.splash.SplashActivityState State) {
        this.mState = State;
    }
